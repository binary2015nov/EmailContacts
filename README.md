...
![EmailContacts Screenshot](https://github.com/binary2015nov/EmailContacts/blob/master/src/EmailContacts/Content/splash.png)

The entire UI is maintained in a single 
[default.cshtml](https://github.com/binary2015nov/EmailContacts/blob/master/src/EmailContacts/default.cshtml) 
...
Adding this to the [Web.config](https://github.com/binary2015nov/EmailContacts/blob/master/src/EmailContacts/Web.config#L16-L21) tells ASP.NET to route all HTTP Requests to ServiceStack:
...
OrmLite has [providers for most major RDBMS's](https://github.com/binary2015nov/ServiceStack.OrmLite/#download) which are configured in the same way by registering the connection string and which dialect to use.
...
As Razor Pages provide full access to framework features, it enables a few different ways to accesss data from within your pages, shown in [info.cshtml](https://github.com/binary2015nov/EmailContacts/blob/master/src/EmailContacts/info.cshtml):
...
[OrmLite](https://github.com/binary2015nov/ServiceStack.OrmLite/) and [Dapper](https://github.com/StackExchange/Dapper). 
...
This is the entire contents of the [/Views/GetContact.cshtml](https://github.com/binary2015nov/EmailContacts/blob/master/src/EmailContacts/Views/GetContact.cshtml) page which can be viewed at [/contacts/1](/contacts/1). 
...
To showcase how it can simplify general web development, we'll walkthrough the JavaScript needed to provide all the behavior for the [entire UI](https://github.com/binary2015nov/EmailContacts/blob/master/src/EmailContacts/default.cshtml), captured in the 70 lines of JavaScript below using nothing other than jQuery and bootstrap.js:
...
![HTML Validation](https://github.com/binary2015nov/EmailContacts/blob/master/src/EmailContacts/Content/html-validation.png)
...
![Rabbit MQ EmailContact Inbox](https://github.com/binary2015nov/EmailContacts/blob/master/src/EmailContacts/Content/rabbitmq-inq.png)
